## Emits the JS wire-constants block (src/chemistry/wire_constants.nim) on
...
## dist/wire_constants.js and injects a <script src> for it into the dist HTML
## page -- same constants, same source, different delivery.
import ../src/chemistry/wire_constants
